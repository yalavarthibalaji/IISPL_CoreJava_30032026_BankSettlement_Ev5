 ...
 *
 * Fintech partners (e.g., Razorpay, PayU, BillDesk, Stripe) integrate with
 * our bank via REST webhooks and send JSON payloads.
 *
 * EXPECTED RAW PAYLOAD FORMAT (JSON string from Fintech partner):
 *   {
 *     "partnerRef"  : "RAZORPAY-TXN-8829",
 *     "type"        : "CREDIT",
 *     "value"       : "12500.75",
 *     "ccy"         : "INR",
 ...
 *   - "partnerRef"  instead of "sourceRef"
 *   - "type"        instead of "txnType"
 *   - "value"       instead of "amount"
 *   - "ccy"         instead of "currency"
 *   - "settlDate"   instead of "valueDate"
 *
...
public class FintechAdapter implements TransactionAdapter {
    ...
    /**
     * Parses a Fintech partner JSON payload and returns a canonical IncomingTransaction.
     *
     * Example input:
     ...
     * Same logic as RtgsAdapter — handles quoted string values and bare numbers.
     */
