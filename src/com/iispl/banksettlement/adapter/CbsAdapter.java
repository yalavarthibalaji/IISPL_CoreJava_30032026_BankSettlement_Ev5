 ...
 *    [0]sourceRef [1]txnType [2]amount [3]currency [4]valueDate [5]debitAcc [6]creditAcc
 *
...
public class CbsAdapter implements TransactionAdapter {
    ...
    // The SourceSystem object representing CBS — set once, reused for every transaction
    ...
    /**
     * Parses a CBS pipe-delimited payload and returns a canonical IncomingTransaction.
     *
    ...
    public IncomingTransaction adapt(String rawPayload) {
        ...
        if (parts.length < 5) {
            throw new IllegalArgumentException(
                "CbsAdapter: Invalid CBS payload format. Expected at least 5 pipe-separated fields. Got: " + rawPayload
            );
        }
    ...
    /**
     * Builds a standardised JSON string from parsed CBS fields.
     * All adapters produce the same JSON structure so downstream code
     * doesn't need to know the original format.
     */
