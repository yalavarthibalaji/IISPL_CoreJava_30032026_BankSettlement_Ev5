...
/**
 * SettlementRecord — Represents the result of settling ONE transaction
 * within a SettlementBatch.
 *
 * WHY THIS CLASS EXISTS:
 *   When a SettlementBatch runs, each transaction inside it is settled
 *   individually. The result of settling each transaction is stored as
 *   a SettlementRecord. Whether it succeeded or failed — both are recorded.
 *
 * COMPOSITION relationship with SettlementBatch:
 *   SettlementBatch HAS-A List<SettlementRecord>
 *   A SettlementRecord belongs to exactly one SettlementBatch.
 *
...
public class SettlementRecord {
     ...
     */
    public SettlementRecord(String batchId, Long incomingTxnId,
                            BigDecimal settledAmount, SettlementStatus settledStatus,
