 ...
 *
 * Every entity in the system (Account, Customer, Transaction, SettlementBatch etc.)
 * extends this class to inherit common audit fields.
 *
 * Implements:
 *   - Auditable  : provides createdAt, updatedAt, createdBy
...
public abstract class BaseEntity implements Auditable, Serializable {
    ...
    /**
     * Default constructor.
     * Sets createdAt and updatedAt to current time automatically.
     * createdBy must be set explicitly by the calling code.
     */
    public BaseEntity() {
    ...
    /**
     * Call this method every time you update any field on a subclass.
     * This keeps the updatedAt timestamp accurate.
     */
