...
/**
 * SourceSystem — Represents an external system that sends transactions into the
 * bank settlement pipeline.
 *
 * Examples: CBS (Core Banking), RTGS, SWIFT, NEFT, UPI, Fintech APIs.
 *
 * This is a HAS-A component inside IncomingTransaction. Every incoming
 * transaction must know which source system sent it.
 *
...
public class SourceSystem extends BaseEntity {
	...
	/**
	 * Default constructor — required for creating empty objects before setting
	 * fields one by one.
	 */
	public SourceSystem() {
		super();
	 ...
	 */
	public SourceSystem(String systemCode, ProtocolType protocol, String connectionConfig, boolean isActive,
			String contactEmail) {
	...
	public String toString() {
		return "SourceSystem{" + "sourceSystemId=" + sourceSystemId + ", systemCode='" + systemCode + '\''
				+ ", protocol=" + protocol + ", isActive=" + isActive + ", contactEmail='" + contactEmail + '\'' + '}';
	}
}
