...
/**
 * InterBankTransactionDao — Interface for all DB operations on interbank_transaction table.
 *
...
public interface InterBankTransactionDao {
    ...
    /**
     * Saves a new InterBankTransaction to the interbank_transaction table.
