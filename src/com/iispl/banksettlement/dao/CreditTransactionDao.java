...
/**
 * CreditTransactionDao — Interface for all DB operations on credit_transaction table.
 *
...
public interface CreditTransactionDao {
    ...
    /**
     * Saves a new CreditTransaction to the credit_transaction table.
    ...
    /**
     * Updates the status of a CreditTransaction.
     * Called as: INITIATED → VALIDATED → PENDING_SETTLEMENT → SETTLED or FAILED
     *
     * @param txnId  The primary key in credit_transaction table
