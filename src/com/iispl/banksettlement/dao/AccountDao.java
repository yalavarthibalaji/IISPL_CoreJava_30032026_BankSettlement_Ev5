 ...
 *
 * Used during ingestion validation to check if an account exists
 * and is ACTIVE before accepting a transaction.
 *
 * RULE: Interface declares WHAT to do.
 *       AccountDaoImpl decides HOW using JDBC.
 */
public interface AccountDao {
    ...
    /**
     * Checks if an account with this number exists AND is ACTIVE.
