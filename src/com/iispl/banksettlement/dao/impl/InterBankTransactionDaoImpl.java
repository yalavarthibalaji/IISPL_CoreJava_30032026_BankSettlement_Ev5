...
/**
 * InterBankTransactionDaoImpl — JDBC implementation for interbank_transaction table.
 *
 * ACTUAL TABLE COLUMNS (from Supabase schema):
 *   txn_id, debit_account_id, credit_account_id, correspondent_bank_code,
...
public class InterBankTransactionDaoImpl implements InterBankTransactionDao {
    ...
    private static final String SQL_FIND_BY_ID =
            "SELECT * FROM interbank_transaction WHERE txn_id = ?";

    private static final String SQL_FIND_BY_CORRESPONDENT =
    ...
    public void save(InterBankTransaction txn) {
        ...
        try {
            ...
            throw new RuntimeException(
                "InterBankTransactionDaoImpl.save() failed: " + e.getMessage(), e);
        } finally {
    ...
    public InterBankTransaction findById(Long txnId) {
        ...
        try {
            ...
            throw new RuntimeException(
                "InterBankTransactionDaoImpl.findById() failed: " + e.getMessage(), e);
        } finally {
    ...
    public void updateStatus(Long txnId, String status) {
        ...
        try {
            ...
            throw new RuntimeException(
                "InterBankTransactionDaoImpl.updateStatus() failed: " + e.getMessage(), e);
        } finally {
            closeResources(ps, conn);
        }
    }
