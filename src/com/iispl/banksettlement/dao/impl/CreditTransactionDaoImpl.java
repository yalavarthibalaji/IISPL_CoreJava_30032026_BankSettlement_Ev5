 ...
 *   txn_id, debit_account_id, credit_account_id, credit_account_number,
 ...
 *       The link back to incoming_transaction is via reference_number
 *       which stores the sourceRef from IncomingTransaction.
 */
public class CreditTransactionDaoImpl implements CreditTransactionDao {
    ...
    private static final String SQL_FIND_BY_ID =
            "SELECT * FROM credit_transaction WHERE txn_id = ?";
        ...
        try {
            ...
            if (rowsAffected == 0) {
                throw new RuntimeException(
                    "CreditTransactionDaoImpl.save() failed — no rows inserted for ref: "
            ...
            throw new RuntimeException(
                "CreditTransactionDaoImpl.save() failed: " + e.getMessage(), e);
        } finally {
    ...
    public CreditTransaction findById(Long txnId) {
        ...
        try {
            ...
            throw new RuntimeException(
                "CreditTransactionDaoImpl.findById() failed: " + e.getMessage(), e);
        } finally {
    ...
    public void updateStatus(Long txnId, String status) {
        ...
        try {
            ...
            throw new RuntimeException(
                "CreditTransactionDaoImpl.updateStatus() failed: " + e.getMessage(), e);
        } finally {
            closeResources(ps, conn);
        }
    }
