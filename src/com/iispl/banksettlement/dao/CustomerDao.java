 ...
 *
 * Used during ingestion validation to check if the customer linked to an
 * account exists and has KYC status = VERIFIED.
 *
 * RULE: Interface declares WHAT to do. CustomerDaoImpl decides HOW using JDBC.
 */
public interface CustomerDao {

	/**
	 * Finds a Customer by their primary key (id). Returns null if not found.
	 *
	...
	/**
	 * Checks if a customer exists and has KycStatus = VERIFIED. This is the main
